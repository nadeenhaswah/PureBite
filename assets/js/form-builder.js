                ...
                <div class="col-md-8">
                    <div class="mb-4">
                        <label for="form-title" class="form-label fw-bold">
                            <i class="fas fa-heading me-1"></i>Form Title *
                        </label>
                        <input type="text" class="form-control form-control-lg" 
                               id="form-title" placeholder="Example: Dietary Habits Assessment" 
                               value="${formData.title}" required>
                    </div>
                    
                    <div class="mb-4">
                        <label for="form-description" class="form-label fw-bold">
                            <i class="fas fa-align-left me-1"></i>Form Description
                        </label>
                        <textarea class="form-control" id="form-description" 
                                  rows="4" placeholder="Brief description of the form and its objectives..."
